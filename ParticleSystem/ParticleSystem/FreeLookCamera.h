...
public:
	...
	virtual void updateCamera(CameraModel<glm::mat4, glm::vec4, float>* camera){
		...
		rotX = glm::rotate(camera->getPitch(),glm::fvec3( 1.0f, 0.0f, 0.0f));
		rotY = glm::rotate(camera->getYaw(), glm::fvec3(0.0f, 1.0f, 0.0f));
		rotZ = glm::rotate(camera->getRoll(), glm::fvec3(0.0f, 0.0f, 1.0f));

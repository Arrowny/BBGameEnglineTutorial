...
void TestGame::init()
{
	...
	//BasicShader bs = BasicShader("./res/basicShader");
	m_shader = new BasicShader("./res/btShader");
	...
	m_material = new Material(new Texture("./res/pikaqiu2.jpg"), glm::fvec3(1.0, 1.0, 1.0), 2, 16);

...
glm::mat4 Transform::getTransformation() const
{
	...
	glm::mat4 rotXMat = glm::rotate(m_rot.x, glm::vec3(1.0, 0.0, 0.0f));
	glm::mat4 rotYMat = glm::rotate(m_rot.y, glm::vec3(0.0, 1.0, 0.0f));
	glm::mat4 rotZMat = glm::rotate(m_rot.z, glm::vec3(0.0, 0.0, 1.0f));

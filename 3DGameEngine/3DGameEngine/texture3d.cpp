...
void Texture3d::InitTexture(std::string* fileNames)
{
	...
	glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_WRAP_S, __GLEW_ARB_texture_mirror_clamp_to_edge);
	glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_WRAP_T, __GLEW_ARB_texture_mirror_clamp_to_edge);
	glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_WRAP_R, __GLEW_ARB_texture_mirror_clamp_to_edge);
